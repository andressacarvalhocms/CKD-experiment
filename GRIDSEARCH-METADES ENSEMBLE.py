...
parameters = [{"classifier__pipe1__rfc__DFP": [False, True], "classifier__pipe1__rfc__knne": [False, True], 
               "classifier__pipe1__rfc__k": [2,3,5,7], "classifier__pipe1__rfc__mode": ['selection','weighting', 'hybrid'],
               "classifier__pipe1__rfc__Kp": [6,7,8], "classifier__pipe1__rfc__knn_classifier": ['knn', 'faiss', None], 
               "classifier__pipe1__rfc__safe_k": [None,4,5,6,7]
              },
              {"classifier__pipe2__rfc__DFP": [False, True], "classifier__pipe2__rfc__knne": [False, True], 
               "classifier__pipe2__rfc__k": [2,3,5,7], "classifier__pipe2__rfc__mode": ['selection','weighting', 'hybrid'],
               "classifier__pipe2__rfc__Kp": [6,7,8], "classifier__pipe2__rfc__knn_classifier": ['knn', 'faiss', None], 
                "classifier__pipe2__rfc__safe_k": [None,4,5,6,7]
              },
              {"classifier__pipe3__rfc__DFP": [False, True], "classifier__pipe3__rfc__knne": [False, True], 
               "classifier__pipe3__rfc__k": [2,3,5,7], "classifier__pipe3__rfc__mode": ['selection','weighting', 'hybrid'],
               "classifier__pipe3__rfc__Kp": [6,7,8], "classifier__pipe3__rfc__knn_classifier": ['knn', 'faiss', None], 
               "classifier__pipe3__rfc__safe_k": [None,4,5,6,7]
              },
              {"classifier__pipe4__rfc__DFP": [False, True], "classifier__pipe4__rfc__knne": [False, True], 
               "classifier__pipe4__rfc__k": [2,3,5,7], "classifier__pipe4__rfc__mode": ['selection','weighting', 'hybrid'],
               "classifier__pipe4__rfc__Kp": [6,7,8], "classifier__pipe4__rfc__knn_classifier": ['knn', 'faiss', None], 
               "classifier__pipe4__rfc__safe_k": [None,4,5,6,7]
              }           
            ]
