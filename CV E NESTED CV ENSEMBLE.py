...
# FOLD1
baseUsada = 'AM-METADES-ITERACAO5-NON-NESTED-ENSEMBLE'
tipo = 'AUMENTO MANUAL'

fold1_train = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/1 FOLD/1FOLD - TREINAMENTO.CSV'
df_fold1_train = read_csv(fold1_train, header=None)
data_fold1_train = df_fold1_train.values

fold1_test = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/1 FOLD/1FOLD - TESTE.CSV'
...
#aqui estão os pipelines dos algoritmos utilizados, descomentar apenas o que quiser calcular

#arvore1 = DecisionTreeClassifier(min_samples_split = 4,ccp_alpha= 0.0,criterion= 'entropy',max_depth= 5,max_features= 0.1)
#pipeline1 = PMMLPipeline([
#  ("classifier", VotingClassifier([
#    ("pipe1", Pipeline(steps=[('preprocessor', preprocessor1),('classifier', arvore1)])),
#    ("pipe2", Pipeline(steps=[('preprocessor', preprocessor2),('classifier', arvore1)])),
#    ("pipe3", Pipeline(steps=[('preprocessor', preprocessor3),('classifier', arvore1)])),
#    ("pipe4", Pipeline(steps=[('preprocessor', preprocessor4),('classifier', arvore1)])),
#  ],voting='soft'))
#])

 
#random = RandomForestClassifier(bootstrap=False, criterion='gini', max_depth=3, max_features= 0.2, n_estimators=75)
#pipeline1 = PMMLPipeline([
#  ("classifier", VotingClassifier([
...
#adaboost = AdaBoostClassifier(arvore, algorithm='SAMME.R',n_estimators=100)
#pipeline1 = PMMLPipeline([
#  ("classifier", VotingClassifier([
...
#ola = OLA(DFP=False, k=2, knn_classifier= None, safe_k=None,with_IH=True)
#pipeline1 = PMMLPipeline([
#  ("classifier", VotingClassifier([
...
#lca = LCA(DFP=False, k=2, knn_classifier=None, with_IH=False, safe_k=None)
#pipeline1= PMMLPipeline([
#  ("classifier", VotingClassifier([
...
metades = METADES(DFP=False, k=3, Kp=6, knn_classifier='knn', knne=False, mode='weighting', safe_k= None)
pipeline1 = PMMLPipeline([
  ("classifier", VotingClassifier([
...
#knorae = KNORAE(DFP=True, k=8, safe_k=6, knn_classifier='knn', knne=False, with_IH=True)
#pipeline1 = PMMLPipeline([
#  ("classifier", VotingClassifier([
...
#knorau = KNORAU(DFP=False, k=3, safe_k=None, knn_classifier=None, knne=False, with_IH=True)
#pipeline1 = PMMLPipeline([
#  ("classifier", VotingClassifier([
...
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/'+tipo+'/1 FOLD/' + baseUsada + '1FOLD-ROC'
...
#plt.show()
ende2 = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/'+tipo+'/1 FOLD/' + baseUsada + '1FOLD-PR'
...
fold2_train = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/2 FOLD/2FOLD - TREINAMENTO.CSV'
df_fold2_train = read_csv(fold2_train, header=None)
data_fold2_train = df_fold2_train.values

fold2_test = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/2 FOLD/2FOLD - TESTE.CSV'
...
metades = METADES(DFP=False, k=7, Kp=6, knn_classifier='knn', knne=False, mode='weighting', safe_k= 4)
...
plt.yticks(np.arange(0.0, 1.1, step=0.2), fontsize=12)
plt.legend(prop={'size':11}, loc='lower right')
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/'+tipo+'/2 FOLD/' + baseUsada + '2FOLD-ROC'
plt.savefig(ende,dpi=300);
...
ende2 = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/'+tipo+'/2 FOLD/' + baseUsada+ '2FOLD-PR'
plt.savefig(ende2,dpi=300);
...
fold3_train = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/3 FOLD/3FOLD - TREINAMENTO.CSV'
df_fold3_train = read_csv(fold3_train, header=None)
data_fold3_train = df_fold3_train.values

fold3_test = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/3 FOLD/3FOLD - TESTE.CSV'
...
metades = METADES(DFP=True, k=2, Kp=8, knn_classifier='knn', knne=False, mode='selection', safe_k= None)
...
plt.yticks(np.arange(0.0, 1.1, step=0.2), fontsize=12)
plt.legend(prop={'size':11}, loc='lower right')
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/'+tipo+'/3 FOLD/' + baseUsada + '3FOLD-ROC'
plt.savefig(ende,dpi=300);
...
plt.title('Extension of Precision-Recall curve to multi-class')
plt.legend(lines, labels, loc=(0, -.38), prop=dict(size=14))
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/'+tipo+'/3 FOLD/' + baseUsada + '3FOLD-PR'
plt.savefig(ende,dpi=300);
...
fold4_train = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/4 FOLD/4FOLD - TREINAMENTO.CSV'
df_fold4_train = read_csv(fold4_train, header=None)
data_fold4_train = df_fold4_train.values

fold4_test = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/4 FOLD/4FOLD - TESTE.CSV'
...
metades = METADES(DFP=True, k=7, Kp=8, knn_classifier='knn', knne=False, mode='selection', safe_k=4)
...
plt.yticks(np.arange(0.0, 1.1, step=0.2), fontsize=12)
plt.legend(prop={'size':11}, loc='lower right')
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/4 FOLD/' + baseUsada + '4FOLD-ROC'
plt.savefig(ende,dpi=300);
...
plt.title('Extension of Precision-Recall curve to multi-class')
plt.legend(lines, labels, loc=(0, -.38), prop=dict(size=14))
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/4 FOLD/' + baseUsada + '4FOLD-PR'
plt.savefig(ende,dpi=300);
...
fold5_train = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/5 FOLD/5FOLD - TREINAMENTO.CSV'
df_fold5_train = read_csv(fold5_train, header=None)
data_fold5_train = df_fold5_train.values

fold5_test = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/5 FOLD/5FOLD - TESTE.CSV'
...
metades = METADES(DFP=True, k=5, Kp=8, knn_classifier=None, knne=False, mode='weighting', safe_k= None)
...
plt.yticks(np.arange(0.0, 1.1, step=0.2), fontsize=12)
plt.legend(prop={'size':11}, loc='lower right')
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/5 FOLD/' + baseUsada + '5FOLD-ROC'
plt.savefig(ende,dpi=300);
...
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/5 FOLD/' + baseUsada + '5FOLD-PR'
plt.savefig(ende,dpi=300);
...
fold6_train = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/6 FOLD/6FOLD - TREINAMENTO.CSV'
df_fold6_train = read_csv(fold6_train, header=None)
data_fold6_train = df_fold6_train.values

fold6_test = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/6 FOLD/6FOLD - TESTE.CSV'
...
metades = METADES(DFP=False, k=7, Kp=4, knn_classifier=None, knne=False, mode='hybrid', safe_k=None)
...
plt.yticks(np.arange(0.0, 1.1, step=0.2), fontsize=12)
plt.legend(prop={'size':11}, loc='lower right')
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/6 FOLD/' + baseUsada + '6FOLD-ROC'
plt.savefig(ende,dpi=300);
...
plt.figure(figsize=(7, 8))
f_scores6 = np.linspace(0.2, 0.8, num=4)
lines = []
labels = []
for f_score6 in f_scores6:
    x = np.linspace(0.01, 1)
    y = f_score6 * x / (2 * x - f_score6)
    l, = plt.plot(x[y >= 0], y[y >= 0], color='gray', alpha=0.2)
    plt.annotate('f1={0:0.1f}'.format(f_score6), xy=(0.9, y[45] + 0.02))
...
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/6 FOLD/' + baseUsada + '6FOLD-PR'
plt.savefig(ende,dpi=300);
...
fold7_train = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/7 FOLD/7FOLD - TREINAMENTO.CSV'
df_fold7_train = read_csv(fold7_train, header=None)
data_fold7_train = df_fold7_train.values

fold7_test = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/7 FOLD/7FOLD - TESTE.CSV'
...
metades = METADES(DFP=False, k=3, Kp=8, knn_classifier=None, knne=False, mode='selection', safe_k= None)
pipeline7 = PMMLPipeline([
  ("classifier", VotingClassifier([
    ("pipe1", Pipeline(steps=[('preprocessor', preprocessor1),('rfc', metades)])),
    ("pipe2", Pipeline(steps=[('preprocessor', preprocessor2),('rfc', metades)])),
    ("pipe3", Pipeline(steps=[('preprocessor', preprocessor3),('rfc', metades)])),
...
plt.yticks(np.arange(0.0, 1.1, step=0.2), fontsize=12)
plt.legend(prop={'size':11}, loc='lower right')
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/7 FOLD/' + baseUsada + '7FOLD-ROC'
plt.savefig(ende,dpi=300);
...
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/7 FOLD/' + baseUsada + '7FOLD-PR'
plt.savefig(ende,dpi=300);
...
fold8_train = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/8 FOLD/8FOLD - TREINAMENTO.CSV'
df_fold8_train = read_csv(fold8_train, header=None)
data_fold8_train = df_fold8_train.values

fold8_test = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/8 FOLD/8FOLD - TESTE.CSV'
...
metades = METADES(DFP=True, k=7, Kp=6, knn_classifier='knn', knne=False, mode='weighting', safe_k= 5)
pipeline8 = PMMLPipeline([
  ("classifier", VotingClassifier([
    ("pipe1", Pipeline(steps=[('preprocessor', preprocessor1),('rfc', metades)])),
    ("pipe2", Pipeline(steps=[('preprocessor', preprocessor2),('rfc', metades)])),
    ("pipe3", Pipeline(steps=[('preprocessor', preprocessor3),('rfc', metades)])),
...
plt.yticks(np.arange(0.0, 1.1, step=0.2), fontsize=12)
plt.legend(prop={'size':11}, loc='lower right')
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/8 FOLD/' + baseUsada + '8FOLD-ROC'
plt.savefig(ende,dpi=300);
...
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/8 FOLD/' + baseUsada + '8FOLD-PR'
plt.savefig(ende,dpi=300);
...
fold9_train = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/9 FOLD/9FOLD - TREINAMENTO.CSV'
df_fold9_train = read_csv(fold9_train, header=None)
data_fold9_train = df_fold9_train.values

fold9_test = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/9 FOLD/9FOLD - TESTE.CSV'
...
metades = METADES(DFP=True, k=7, Kp=7, knn_classifier='knn', knne=False, mode='hybrid', safe_k= 7)
pipeline9 = PMMLPipeline([
  ("classifier", VotingClassifier([
    ("pipe1", Pipeline(steps=[('preprocessor', preprocessor1),('rfc', metades)])),
    ("pipe2", Pipeline(steps=[('preprocessor', preprocessor2),('rfc', metades)])),
    ("pipe3", Pipeline(steps=[('preprocessor', preprocessor3),('rfc', metades)])),
...
plt.yticks(np.arange(0.0, 1.1, step=0.2), fontsize=12)
plt.legend(prop={'size':11}, loc='lower right')
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/9 FOLD/' + baseUsada + '9FOLD-ROC'
plt.savefig(ende,dpi=300);
...
plt.title('Extension of Precision-Recall curve to multi-class')
plt.legend(lines, labels, loc=(0, -.38), prop=dict(size=14))
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/9 FOLD/' + baseUsada + '9FOLD-PR'
plt.savefig(ende,dpi=300);
...
fold10_train = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/10 FOLD/10FOLD - TREINAMENTO.CSV'
df_fold10_train = read_csv(fold10_train, header=None)
data_fold10_train = df_fold10_train.values

fold10_test = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/AUMENTO MANUAL/10 FOLD/10FOLD - TESTE.CSV'
...
metades = METADES(DFP=True, k=7, Kp=7, knn_classifier='knn', knne=False, mode='weighting', safe_k=5)
pipeline10 = PMMLPipeline([
  ("classifier", VotingClassifier([
    ("pipe1", Pipeline(steps=[('preprocessor', preprocessor1),('rfc', metades)])),
    ("pipe2", Pipeline(steps=[('preprocessor', preprocessor2),('rfc', metades)])),
    ("pipe3", Pipeline(steps=[('preprocessor', preprocessor3),('rfc', metades)])),
...
plt.yticks(np.arange(0.0, 1.1, step=0.2), fontsize=12)
plt.legend(prop={'size':11}, loc='lower right')
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/10 FOLD/' + baseUsada + '10FOLD-ROC'
plt.savefig(ende,dpi=300);
...
ende = 'D:/Mestrado/ARTIGO DRC/dados_pos_revisao/cross validation - dados reavaliados/4 revisao/CROSS-VALIDATION/' + tipo +'/10 FOLD/' + baseUsada + '10FOLD-PR'
plt.savefig(ende,dpi=300);
